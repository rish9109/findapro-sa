...
export default function AccreditationModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-2 md:p-4 bg-black/70">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-2xl bg-gray-800 shadow-2xl">
        {/* Header */}
        ...
        <div className="sticky bottom-0 bg-gray-800 px-4 py-4 border-t border-gray-700">
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSave}
              className="flex-1 px-4 py-2.5 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-lg font-medium hover:from-orange-500 hover:to-orange-400 text-sm"
            >
